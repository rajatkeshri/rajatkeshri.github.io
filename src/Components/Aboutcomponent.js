                    ...
                    <div className="row justify-content-center">
                        <div className="col-sm-12">
                            <Fade cascade triggerOnce={"true"} delay={500}>
                                ...
                                <br></br><br></br>I have been programming for 6+ years now and it has become a true passion of mine. This passion continually grows with every new innovation in the tech industry. I have experience in multiple software  domains and technologies, ranging from <span className="pcolor">Software Development, Cloud Automation Software, Machine Learning and Data Analytics, to Front-end Web Development and Server Side Development. </span>
